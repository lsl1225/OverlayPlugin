namespace RainbowMage.OverlayPlugin.Overlays
{
    partial class MiniParseConfigPanel
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tabControl1 = new Advanced_Combat_Tracker.TabControlPainted();
			...
			this.buttonMiniParseSelectFile = new Advanced_Combat_Tracker.ButtonPainted();
			...
			this.btnApplyHotkeyChanges = new Advanced_Combat_Tracker.ButtonPainted();
			this.btnRemoveHotkey = new Advanced_Combat_Tracker.ButtonPainted();
			this.btnAddHotkey = new Advanced_Combat_Tracker.ButtonPainted();
			...
			this.btnResetZoom = new Advanced_Combat_Tracker.ButtonPainted();
			...
			this.buttonMiniParseOpenDevTools = new Advanced_Combat_Tracker.ButtonPainted();
			this.buttonMiniParseReloadBrowser = new Advanced_Combat_Tracker.ButtonPainted();
			this.buttonResetOverlayPosition = new Advanced_Combat_Tracker.ButtonPainted();
        ...
        private Advanced_Combat_Tracker.TabControlPainted tabControl1;
        ...
        private Advanced_Combat_Tracker.ButtonPainted buttonMiniParseOpenDevTools;
        private Advanced_Combat_Tracker.ButtonPainted buttonMiniParseReloadBrowser;
        private Advanced_Combat_Tracker.ButtonPainted buttonResetOverlayPosition;
        private System.Windows.Forms.TableLayoutPanel tableLayoutPanel2;
        private System.Windows.Forms.TextBox textMiniParseUrl;
        private Advanced_Combat_Tracker.ButtonPainted buttonMiniParseSelectFile;
        ...
        private Advanced_Combat_Tracker.ButtonPainted btnResetZoom;
        private System.Windows.Forms.CheckBox checkLogConsoleMessages;
        private System.Windows.Forms.TabPage tabACTWS;
        private Advanced_Combat_Tracker.ButtonPainted btnAddHotkey;
        private Advanced_Combat_Tracker.ButtonPainted btnRemoveHotkey;
        private Advanced_Combat_Tracker.ButtonPainted btnApplyHotkeyChanges;
