namespace RainbowMage.OverlayPlugin.Overlays
{
    partial class LogParseConfigPanel
    {
        ...
        private void InitializeComponent()
        {
			...
			this.buttonLogParseCopyActXiv = new Advanced_Combat_Tracker.ButtonPainted();
			this.buttonLogParseOpenDevTools = new Advanced_Combat_Tracker.ButtonPainted();
			this.buttonLogParseReloadBrowser = new Advanced_Combat_Tracker.ButtonPainted();
			this.tableLayoutPanel2 = new System.Windows.Forms.TableLayoutPanel();
			this.textLogParseUrl = new System.Windows.Forms.TextBox();
			this.buttonLogParseSelectFile = new Advanced_Combat_Tracker.ButtonPainted();
        ...
        private Advanced_Combat_Tracker.ButtonPainted buttonLogParseReloadBrowser;
        private Advanced_Combat_Tracker.ButtonPainted buttonLogParseOpenDevTools;
        private Advanced_Combat_Tracker.ButtonPainted buttonLogParseCopyActXiv;
        private System.Windows.Forms.TableLayoutPanel tableLayoutPanel2;
        private System.Windows.Forms.TextBox textLogParseUrl;
        private Advanced_Combat_Tracker.ButtonPainted buttonLogParseSelectFile;
