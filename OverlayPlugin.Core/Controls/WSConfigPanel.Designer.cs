namespace RainbowMage.OverlayPlugin
{
    partial class WSConfigPanel
    {
        ...
        private void InitializeComponent()
        {
			...
			this.genSslBtn = new Advanced_Combat_Tracker.ButtonPainted();
			this.sslBox = new System.Windows.Forms.CheckBox();
			this.logDisplay = new System.Windows.Forms.TextBox();
			this.startBtn = new Advanced_Combat_Tracker.ButtonPainted();
			this.stopBtn = new Advanced_Combat_Tracker.ButtonPainted();
			...
			this.tabControl = new Advanced_Combat_Tracker.TabControlPainted();
			...
			this.simpStopBtn = new Advanced_Combat_Tracker.ButtonPainted();
			this.simpStartBtn = new Advanced_Combat_Tracker.ButtonPainted();
        ...
        private Advanced_Combat_Tracker.ButtonPainted genSslBtn;
        private System.Windows.Forms.CheckBox sslBox;
        private System.Windows.Forms.TextBox logDisplay;
        private Advanced_Combat_Tracker.ButtonPainted startBtn;
        private Advanced_Combat_Tracker.ButtonPainted stopBtn;
        ...
        private Advanced_Combat_Tracker.TabControlPainted tabControl;
        private System.Windows.Forms.TabPage settingsPage;
        private System.Windows.Forms.TabPage tunnelPage;
        private Advanced_Combat_Tracker.ButtonPainted simpStopBtn;
        private Advanced_Combat_Tracker.ButtonPainted simpStartBtn;
